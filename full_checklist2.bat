...
REM Disabling taskview...
powershell -NoProfile -ExecutionPolicy Bypass -File ".\scripts\disable_taskview.ps1"

REM Disabling widgets...
powershell -NoProfile -ExecutionPolicy Bypass -File ".\scripts\disable_widgets.ps1"

REM Turn searchbar into search icon...
REM powershell -NoProfile -ExecutionPolicy Bypass -File ".\scripts\taskbar_search_icon.ps1"
